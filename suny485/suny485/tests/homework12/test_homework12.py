...
2. Testing Output
    - The output should be a positive integer that is in the range of 0-100(including)
...
[
    ...
    ('owen', 0), #Testing a string with no complpexifiers
    ('ojc@', 25), #Testing a string with complexifiers
])
...
[
    ('@#$%&^', 100), #Testing a string with only complexifiers
    ('O1w=e#43', 25), #Testing a string with a mix of complexifiers and integers and letters
    ('ojc@icloud--%', 30.76923076923077), #Testing a string with multiple complexifiers
    ('owencozin$', 10)#Testing a string with one complexifier
])
